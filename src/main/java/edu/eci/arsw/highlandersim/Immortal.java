...
public class Immortal extends Thread {
    ...
    private AtomicBoolean pausa;//variable pausa juego
    ...
    public void run() {
        while (true) {
            ...
            synchronized (immortalsPopulation) {//Se agrega esta linea para que dos inmoratles no ataquen al tiempo
                this.fight(im);
            }
            try {
                Thread.sleep(1);
